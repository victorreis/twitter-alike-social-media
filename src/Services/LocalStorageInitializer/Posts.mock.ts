...
export const mockedPosts: PostType[] = [
  {
    ...
    id: nanoid(),
    text,
    createdAt: dayjs('01-01-2021', dateFormat).toDate(),
  ...
  },
  {
    ...
    id: nanoid(),
    text,
    createdAt: dayjs('02-02-2021', dateFormat).toDate(),
    createdBy: LOGGED_IN_USER,
    reposts: getRandomNumber(),
    quotPosts: getRandomNumber(),
  },
  {
    ...
    id: nanoid(),
    text,
    createdAt: dayjs('03-03-2021', dateFormat).toDate(),
    createdBy: LOGGED_IN_USER,
    reposts: getRandomNumber(),
    quotPosts: getRandomNumber(),
  },
...
export const mockedReposts: RepostType[] = [
  {
    ...
    id: nanoid(),
    createdAt: dayjs('01-01-2022', dateFormat).toDate(),
    createdBy: LOGGED_IN_USER,
  },
  {
    type: 'Repost',
